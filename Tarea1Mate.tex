...
\begin{align*}
    ...
    \frac{l_0}{2h} &= \frac{l_j}{2(h - h_j)}&\quad V_j &=   \frac{h \cdot l_0 \cdot (h - h_j)}{50 h^2} \\
    \frac{l_0 \cdot 2(h - h_j)}{2h} &= l_j&\quad V_j &=   \frac{l_0 \cdot (h - h_j)}{50 h}\\
    \frac{l_0 \cdot (h - h_j)}{h} &= l_j
\end{align*}
